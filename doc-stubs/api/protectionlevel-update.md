---
title: "Update protectionLevel"
description: "Update the properties of a protectionLevel object."
...
# Update protectionLevel
Namespace: microsoft.graph

Update the properties of a [protectionLevel](../resources/protectionlevel.md) object.
...
-->
``` http
PATCH /conditionalAccess/protectionLevels/{protectionLevelId}
```
...
<!-- {
  "blockType": "request",
  "name": "update_protectionlevel"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/conditionalAccess/protectionLevels/{protectionLevelId}
