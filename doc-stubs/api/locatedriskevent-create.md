...
-->
``` http
POST ** Collection URI for microsoft.graph.locatedRiskEvent not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.locatedRiskEvent not found
...
{
  "@odata.type": "#microsoft.graph.locatedRiskEvent",
  "id": "ce21a8cb-a8cb-ce21-cba8-21cecba821ce",
  "userDisplayName": "String",
  "userPrincipalName": "String",
  "riskEventDateTime": "String (timestamp)",
  "riskEventType": "String",
